...
if __name__ == '__main__':
    text_about_space = "The Hubble.Space.Telescope (often referred to as HST or Hubble) " \
                "is a space telescope that was launched into" \
                ...
                "The Space Telescope Science Institute (STScI) selects Hubble's targets and processes " \
                "the resulting data, while the Goddard Space Flight Center (GSFC) controls the spacecraft."\
                "A commission headed by Lew Allen, director of the Jet Propulsion Laboratory, " \
                "was established to determine how the error could have arisen."\
                "The Allen Commission found that a reflective null corrector, " \
