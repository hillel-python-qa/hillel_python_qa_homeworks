...
# if the friend is not in the list of enemy names. And display the message f"{friend}
# we are not the friends anymore" if the friend is on the list of enemies.
