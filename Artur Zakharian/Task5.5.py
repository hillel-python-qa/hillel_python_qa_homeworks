...
if __name__ == "__main__":
    text = "The Hubble.Space.Telescope (often referred to as HST or Hubble) is a space telescope that was " \
           ...
           "A commission headed by Lew Allen, director of the Jet Propulsion Laboratory, was established " \
           "to determine how the error could have arisen. The Allen Commission found that a reflective null corrector, " \
