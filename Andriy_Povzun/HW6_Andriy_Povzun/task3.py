...
for letter in upper_alphabet:
    ...
    print(f'Count of letter {letter} in upper case: {upper_letters.count(letter)}\n')

for lover_letter in lover_aplhabet:
    lover_letters = re.findall(lover_letter, text)
    print(f'Count of letter {lover_letter} in lover case: {lover_letters.count(lover_letter)}\n')
